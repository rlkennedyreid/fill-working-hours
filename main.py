    ...
    def add_hours(self, project: str, hours: float) -> float:
        ...
        if hours_available > .0:
            ...
            if self.hours_available() < .0:
                raise ValueError(
                    'Day has more hours allocated than the max allowed')

            project_hours_remaining = -excess

            if project_hours_remaining >= .0:
...
class Days:
    ...
    def add_project(self, project: str, hours: float):
        ...
        while project_hours_remaining > .0:
            if self.is_full():
    ...
    def print(self) -> None:
        ...
        if len(table) > 0:
            ...
            print(tabulate(table, tablefmt='fancy_grid',
                           colalign=alignments, headers=headers, showindex=True))
            return
